...
inline size_t GetSeparateKeywordMatchGrade(const wstring &source, const wstring &keyword)
{
...
inline size_t GetKeywordMatchGrade(const wstring &source, const wstring & keyword)
{
	if (source.length() <= 0 || keyword.length() <= 0)
	{
		return 0;
