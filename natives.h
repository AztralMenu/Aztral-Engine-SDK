...
namespace PLAYER
{
	static Ped GET_PLAYER_PED(Player playerid) { return invoke<Ped>(0x43A66C31C68491C0, playerid); } // 0x43A66C31C68491C0 0x6E31E993
	...
	static Vehicle GET_NUMBER_OF_PLAYERS() { return invoke<Vehicle>(0x407C7F91DDB46C16); } // 0x407C7F91DDB46C16 0x4C1B8867
...
namespace ENTITY
{
	static BOOL DOES_ENTITY_EXIST(Object entity) { return invoke<BOOL>(0x7239B21A38F536BA, entity); } // 0x7239B21A38F536BA 0x3AC90869
	...
	static void SET_ENTITY_ALPHA(Entity entity, int alphaLevel, Any p0) { invoke<Void>(0x44A0870B7E92D7C0, entity, alphaLevel, p0); } // 0x44A0870B7E92D7C0 0xAE667CB0
...
namespace VEHICLE
{
	...
	static void _SET_VEHICLE_ROCKET_BOOST_REFILL_TIME(Vehicle vehicle, float seconds) { invoke<Void>(0xE00F2AB100B76E89, vehicle, seconds); } // 0xE00F2AB100B76E89
	...
	static void _SET_VEHICLE_PARACHUTE_ACTIVE(Vehicle vehicle, BOOL active) { invoke<Void>(0x0BFFB028B3DD0A97, vehicle, active); } // 0x0BFFB028B3DD0A97
	...
	static void _SET_AIRCRAFT_COUNTERMEASURE_COUNT(Vehicle aircraft, int countermeasureCount) { invoke<Void>(0x9BDA23BF666F0855, aircraft, countermeasureCount); } // 0x9BDA23BF666F0855
	...
	static float _GET_PLANE_HOVER_MODE_PERCENTAGE(Vehicle plane) { return invoke<float>(0xDA62027C8BDB326E, plane); } // 0xDA62027C8BDB326E
}
...
namespace OBJECT
{
	...
	static void _PED_DEATH_DROP(float x, float y, float z, int amount, bool p1 = 1, Hash modelHash = -1666779307) { invoke<Void>(0x0589B5E791CE9B2B, x, y, z, amount, p1, modelHash); } //money drop 0x0589B5E791CE9B2B
...
namespace GAMEPLAY
{
	...
	static BOOL _0xB335F761606DB47C(Any* p0, Any* p1, Any p2, BOOL p3) { return invoke<BOOL>(0xB335F761606DB47C, p1, p1, p2, p3); } // 0xB335F761606DB47C
...
namespace CAM
{
	...
	static Cam CREATE_CAM(char* Gippo, BOOL p1) { return invoke<Cam>(0xC3981DCE61D9E13F, Gippo, p1); } // 0xC3981DCE61D9E13F 0xE9BF2A7D
...
namespace GRAPHICS
{
	...
	static BOOL _GET_SCREEN_EFFECT_IS_ACTIVE(BOOL effectName) { return invoke<BOOL>(0x36AD3E690DA5ACEB, effectName); } // 0x36AD3E690DA5ACEB 0x089D5921
...
namespace MOBILE
{
	static void CREATE_MOBILE_PHONE(int p3) { invoke<Void>(0xA4E8E696C532FBC7, p3); } // 0xA4E8E696C532FBC7 0x5BBC5E23
...
namespace NETWORK
{
	...
	static void _NETWORK_VOICE_CONNECT_TO_PLAYER(Any* globalPtr) { invoke<Void>(0xABD5E88B8A2D3DB2, globalPtr); } // 0xABD5E88B8A2D3DB2 0x9DFD89E6
	...
	static BOOL _0xC22912B1D85F26B1(int p0, int* p1, Vector3* p2) { return invoke<BOOL>(0xC22912B1D85F26B1, p0, p1, p2); } // 0xC22912B1D85F26B1 0x8570DD34
